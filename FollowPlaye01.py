...
class MyGameWindow(arcade.Window):
    ...
    def setup(self):
        if self.current_state == GAME_WINDOW_1:
            ...
            # this.
            playing_field_left_boundary = -SPRITE_SIZE * 4
            playing_field_right_boundary = SPRITE_SIZE * 60
            playing_field_top_boundary = SPRITE_SIZE * 34
            playing_field_bottom_boundary = -SPRITE_SIZE * 4
